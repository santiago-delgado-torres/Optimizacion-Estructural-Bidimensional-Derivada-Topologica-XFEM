function ES = xfem_ChangingForces(ES)
%
...
%ES=interfase(ES); % Se asume que ya se tiene

% =========================================================================
% === Matriz de rigidez ===================================================
% =========================================================================
 
%ES = matrizXFEM(ES); % se asume que ya se tiene

% =========================================================================
% === Armado de Vector de Fuerzas =========================================
% =========================================================================

ES = NeumannXFEM(ES); % Se vuevle a crear y se actualiza

% =========================================================================
% === Agregado apoyos elasticos ===========================================
% =========================================================================
 
% ES = RobinXFEM(ES); % Se asume que ya se tiene

% =========================================================================
% === Prescripcion de Desplazamientos =====================================
% =========================================================================

ES = DirichletXFEM(ES); % Si bien probablemente se mantenga, se mantiene esta linea por si hay apoyos rotados
